...
namespace Project_01
{
    ...
    {
        /// <summary>
        /// List of imported countries and their VATs
        /// </summary>
        List<Country> CountriesList { get; set; } = new List<Country>();

        /// <summary>
        /// CountriesList was successfully imported and is non-empty
        /// </summary>
        public bool IsValid
        {
            get { return CountriesList.Count > 0; }
        }
        ...
        /// <summary>
        /// Prints top n countries with min or max stadard VAT rate
        /// </summary>
